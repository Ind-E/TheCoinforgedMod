...
public class LuckOfTheDrawPower extends BasePower {
    ...
    public void onCardDraw(AbstractCard card) {
        ...
        if (rand == 0) {
            ...
            AbstractCreature m = AbstractDungeon.getMonsters().getRandomMonster((AbstractMonster) null, true,
                    AbstractDungeon.cardRandomRng);
            if (m != null) {
                addToBot(new DamageAction(m,
                        new DamageInfo(owner, this.amount, com.megacrit.cardcrawl.cards.DamageInfo.DamageType.THORNS),
