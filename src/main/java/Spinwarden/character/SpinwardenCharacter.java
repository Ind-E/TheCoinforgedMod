...
import Spinwarden.cards.RollRed;
import Spinwarden.relics.CasinoCatalyst;
import Spinwarden.relics.LuckRelic;

import static Spinwarden.SpinwardenMain.characterPath;
import static Spinwarden.SpinwardenMain.makeID;

import java.util.ArrayList;

public class SpinwardenCharacter extends CustomPlayer {
    // Stats
    ...
    // Strings
    private static final String ID = makeID("SPINWARDEN"); // This should match whatever you have in the
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass Spinwarden;
        @SpireEnum(name = "SPINWARDEN_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "SPINWARDEN_COLOR")
        @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public SpinwardenCharacter() {
        super(NAMES[0], Enums.Spinwarden,
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Spinwarden.cards.StrikeSpinwarden.ID);
        retVal.add(Spinwarden.cards.StrikeSpinwarden.ID);
        retVal.add(Spinwarden.cards.StrikeSpinwarden.ID);
        retVal.add(Spinwarden.cards.RollRed.ID);
    ...
    public AbstractPlayer newInstance() {
        ...
        return new SpinwardenCharacter();
    }
