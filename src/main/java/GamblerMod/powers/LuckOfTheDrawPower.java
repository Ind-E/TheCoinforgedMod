...
public class LuckOfTheDrawPower extends BasePower{
    ...
    public void onCardDraw(AbstractCard card) {
        ...
        if (rand == 0) {
            ...
            if (m != null) {
                addToBot(new DamageAction(m, new DamageInfo(owner, this.amount, com.megacrit.cardcrawl.cards.DamageInfo.DamageType.THORNS), AbstractGameAction.AttackEffect.SLASH_DIAGONAL));
            }
        } else {
